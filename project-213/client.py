...
class SecondWindow(Screen):
    def __init__(self, **kwargs):
        ...
        self.lb1 = Label(text="REMOTE MOUSE", font_size=60, color=(
            255, 165, 0), pos_hint={"x": 0, "y": 0.4})
        self.add_widget(self.lb1)

        self.leftClick = Button(text="LEFT CLICK", size_hint=(
            0.5, 0.2), background_color=(255, 165, 0), bold=100)
